...
export function FeedbackContentStep({
  ...
  return(
    ...
    <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
      ...
      placeholder="Tell me with details what is happening..."
      //every time that the user type something in text area, the state Comment will update
      ...
      <footer className="flex gap-2 mt-2">
        ...
        <button 
          type='submit'
          //disable button if text area is empty or feedback is being sending
